...
export function CarousselCategory() {
  ...
  return (
    <div className="  py-10">
      <h2 className="container mx-auto text-xl md:text-2xl font-bold  dark:text-neutral-200 font-sans">
        Améliorez votre qualité de vie avec
        <br /> les services à domicile
      </h2>
